...
public class AttachmentEntity
{
    ...
    [MaxLength(16)] public required string ContentType { get; set; }
    public long FileSize { get; set; }
    public AttachmentType Type { get; set; }
    public DateTime UploadDate { get; set; } = DateTime.UtcNow;
    [MaxLength(512)] public required string LocalFilePath { get; set; }
    [MaxLength(512)]public string? RemoteFileUrl { get; set; }
    ...
    public void DetermineType()
    {
        ...
        else if (ContentType == "application/pdf" || ContentType.StartsWith("application/msword") || ContentType.StartsWith("application/vnd"))
